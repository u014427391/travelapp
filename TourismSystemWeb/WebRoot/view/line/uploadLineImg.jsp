...
<div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf">
      	<strong><a href="<%=basePath %>index.jsp">首页</a></strong>/ <strong><a href="<%=basePath %>GetAllLineInfoServlet">旅游路线维护</a></strong>/ <small>上传旅游路线图片</small>
      </div>
    </div>
    ...
    <div class="am-g">
      <div class="am-u-sm-12" align="left">
		...
		<form action="UploadServlet" name="f1" id="f1" method="post" enctype="multipart/form-data" target="if">
	 		...
	 		<input type="button" name="but1" value="提交" onclick="go();" class="am-btn am-btn-primary" />
		</form><br>
