...
<%
	Line l = (Line)session.getAttribute("lineInfo");
 %>
  ...
  <div class="admin-content">
    <div class="am-cf am-padding">
      <div class="am-fl am-cf">
     	 <strong><a href="<%=basePath %>index.jsp">首页</a></strong>/<strong><a href="<%=basePath %>GetAllLineInfoServlet">旅游信息管理</a></strong> / <small>维护旅游路线信息</small>
      </div>
    </div>
    ...
    <div class="am-g">
      ...
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
        <form class="am-form am-form-horizontal" action="<%=basePath %>UpdateLineInfoServlet">
          
          <div class="am-form-group">
            <label class="am-u-sm-3 am-form-label">景点ID</label>
            <div class="am-u-sm-9">
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" name="catering" value=<%=l.getCatering() %> />
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" name="accommodation" value=<%=l.getAccommodation()  %> >
            </div>
          </div>
           ...
           <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" name="traffic" value=<%=l.getTraffic() %> />
            </div>
          </div>
           ...
           <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" name="price" value=<%=l.getPrice()  %> />
            </div>
          </div>

          <div class="am-form-group">
            <label for="pic" class="am-u-sm-3 am-form-label">图片</label>
           <div class="field">
           		<img width="300xp" height="300xp" src=<%=Constant.WEB_SERVER_URL+l.getPicture() %> /> 
           	</div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" name="contact" value=<%=l.getContact()  %> />
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" name="tourism_time" value=<%=l.getTourism_time()  %> />
            </div>
          </div>
			
			<!--  
          <div class="am-form-group">
          	 <label class="am-u-sm-3 am-form-label">修改图片</label>
          	 <div class="field">
