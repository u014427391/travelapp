...
public class ExpandTabView extends LinearLayout implements OnDismissListener {
	...
	public void setValue(ArrayList<View> viewArray,int tabSelectorResId,int tabLineResId) {
		...
		for (int i = 0; i < viewArray.size(); i++) {
			...
			RelativeLayout.LayoutParams rl = new RelativeLayout.LayoutParams(android.view.ViewGroup.LayoutParams.MATCH_PARENT, android.view.ViewGroup.LayoutParams.MATCH_PARENT);
			rl.leftMargin = 0;
			rl.rightMargin = 0;
			...
			addView(tButton,new LayoutParams(0,android.view.ViewGroup.LayoutParams.WRAP_CONTENT,1));
			
			View line = new TextView(mContext);
			line.setBackgroundResource(tabLineResId);
			
			if (i < viewArray.size() - 1) {
				LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(2, android.view.ViewGroup.LayoutParams.MATCH_PARENT);
				addView(line, lp);
			}
			...
			r.setBackgroundColor(Color.parseColor("#FF4C4C4C"));
