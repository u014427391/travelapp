...
<%
	  List<Line> list=(ArrayList<Line>)session.getAttribute("lineList");
%>
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf">
      	<strong><a href="<%=basePath %>index.jsp">首页</a></strong>/ <small>维护旅游路线</small>
      </div>
    </div>
	...
	%>
            <tr>
              <td><img width="60xp" height="60xp" class="am-img-circle am-img-thumbnail" src=<%=Constant.WEB_SERVER_URL+list.get(i).getPicture() %> /></td>
              <td><%=list.get(i).getName() %></td>
              <td><%=list.get(i).getCatering() %></td>
              <td><%=list.get(i).getAccommodation() %></td>
              <td><%=list.get(i).getTraffic() %></td>
              <td><%=list.get(i).getPrice() %></td>
              <td><%=list.get(i).getContact() %></td>
              <td><%=list.get(i).getTourism_time() %></td>
              <td>
                <div class="am-btn-toolbar">
                  <div class="am-btn-group am-btn-group-xs">
                    <a style="background: white;" href="<%=basePath %>GetLineInfoByIdServlet?ID=<%=list.get(i).getID() %>" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 编辑</a>
                    <a style="background: white;" class="am-btn am-btn-default am-btn-xs am-text-danger"><span class="am-icon-trash-o"></span> 删除</a>
                  </div>
                </div>
              </td>
            </tr>
