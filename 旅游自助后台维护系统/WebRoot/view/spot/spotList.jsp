...
<%
	List<Spot> list = (ArrayList<Spot>)session.getAttribute("spotList");
 %>
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf">
      	<strong><a href="<%=basePath %>index.jsp">首页</a></strong>/ <small>维护景点信息</small>
      </div>
    </div>
	...
	%>
            <tr>
              ...
              <td><%=list.get(i).getTour_project() %></td>
              <td><%=list.get(i).getPosition() %></td>
              <td><%=list.get(i).getPrice() %></td>
              <td><%=list.get(i).getTime() %></td>
              <td>
              	<%
              		int sortID = list.get(i).getSpot_sort();
              		if(sortID == 1){
          				out.print("宗教文化");
              	 	}else if(sortID == 2){
              	 		out.print("名胜古迹");
              ...
              <td>
              <%
              	String introString = list.get(i).getIntroduction();
              	if(introString.length()>100){
              		introString = introString.substring(0, 100)+"...";
              	}
              ...
              <td>
                <div class="am-btn-toolbar">
                  <div class="am-btn-group am-btn-group-xs">
                    <a style="background: white;" href="<%=basePath %>GetSpotInfoByIdServlet?ID=<%=list.get(i).getID() %>" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 编辑</a>
