...
<html class="no-js">
  <head>
	...
	<link rel="stylesheet" type="text/css" href="<%=basePath %>css/progress.css">
<script type="text/javascript" src="<%=basePath %>js/uploadAjax.js" charset="UTF-8"></script>

    <script type="text/javascript" src="<%=basePath %>js/lazyload-min.js"></script>
    
    <script type="text/javascript">
        LazyLoad.css(["<%=basePath %>css/cityStyle.css"], function () {
            LazyLoad.js(["<%=basePath %>js/cityScript.js"], function () {
  ...
  <div class="admin-content">
    <div class="am-cf am-padding">
      <div class="am-fl am-cf">
      	<strong><a href="<%=basePath %>index.jsp">首页</a></strong><strong><a href="<%=basePath %>GetAllSpotInfoServlet">景点管理</a></strong> / <small>新增景点信息</small>
      </div>
    </div>
    ...
    <div class="am-g">
      ...
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
        <form class="am-form am-form-horizontal" action="<%=basePath %>AddSpotInfoServlet">
          <div class="am-form-group">
            <label for="user-name" class="am-u-sm-3 am-form-label">项目名称</label>
            <div class="am-u-sm-9">
              <input type="text" placeholder="项目名称" name="tour_project" data-validate="required:请填写项目名称">
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input style="background: white;" type="text" readonly="readonly" placeholder="请输入景点位置" name="position" id="inputTest" />
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" placeholder="输入门票价钱" name="price" data-validate="required:请输入门票价钱">
            </div>
          </div>
          ...
          <div class="am-form-group">
           ...
           <div class="am-form-group am-margin-left am-fl">
              <select name="sort">
                ...
                <option value="1">宗教文化</option>
                <option value="2">名称古迹</option>
                <option value="3">自然景点</option>
                <option value="4">红色旅游</option>
                <option value="5">历史景点</option>
              </select>
            </div>
          </div>
