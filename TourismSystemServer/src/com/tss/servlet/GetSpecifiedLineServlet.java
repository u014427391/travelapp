...
public class GetSpecifiedLineServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException
	{
		...
		String spotName=new String(request.getParameter("spotName").getBytes("ISO-8859-1"),"UTF-8");//景点名称
		...
		try {
			...
			manager.connectDB();
			String sql = "select count(*) from line where name like ?";		
			Object[] params = new Object[]{"%"+spotName+"%"};
